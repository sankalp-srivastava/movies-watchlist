...
<div className="content">
	<h3 className='h3heading'>Hello?? Is somebody there?!?</h3>
	<p className='ppara'>We know it’s scary, but the page you’re trying to reach can’t be found. Perhaps it was just a bad <span style={{textDecoration:'line-through'}}>dream</span> link?</p>
    <br />

    <p><Link to='/'>Let's go back to home page.</Link></p>
</div>
